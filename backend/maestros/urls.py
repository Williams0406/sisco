...
from .views import (
    MaeClienteViewSet,
    MaeChoferViewSet,
    MaeTipoVehiculoViewSet,
    MaeVehiculoViewSet,
    MaeProveedorViewSet,
    MaeTipoEgresoViewSet,
    MaeTipoIngresoViewSet,
    MaeTipoIncidenteViewSet,
    MaeTipoDocumentoViewSet,
    MaeGaritaViewSet,
    MaeUsuarioViewSet,
    MaePerfilViewSet,
)
...
router.register(r'tipo-incidentes', MaeTipoIncidenteViewSet, basename='tipo-incidente')
